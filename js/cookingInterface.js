...
/* Steps information */
var Step, animationMoveProgressBarUp, animationMoveThisStepFromLeftToRight, animationMoveThisStepFromRightToLeft, calculatePercentage, calculateRemainTime, checkFinishPercentageAndChangeTitle, checkNextStep, checkWaitingStepBlocking, checkWaitingStepsFinish, cookingEnded, cookingStarted, extendStepInfo, finishedShowStatus, loadBlockingStep, loadStep, pushStepToWaitingQueue, showTwoUrgentSteps, startTimer, stopTimer, timer, updateNextStepProgressBar, updateWaitingProgressBar, xpos;
...
animationMoveProgressBarUp = function() {
  ...
  afterAnimate = function() {
    ...
    $('#steps_container').append($('<div class="next_step_outer_wrapper nextstep" " data-sn=' + (stepNum + 1) + '>' + '<div id="NextStep" class="next_step_inner_wrapper">' + '<div id="ProgressBar" class="next_step_progress invisible">&nbsp;</div>' + '<h4 id="ProgressName" class="next_step_name">Next: Stirfry mushroom</h4>' + '<h4 id="ProgressRemainTime" class="next_step_time">2:30</h4>' + '</div> ' + '</div>'));
    scope = $("#Step");
    nextStep = window.cookingData.steps[stepNum + 1];
    if (nextStep != null) {
      scope.find(".next_step_name").html(trimStringLength(nextStep.stepName));
